    ...
    return (
        <BrowserRouter>
            ...
            <Route path="/homepage" exact>
                <Header searchContent={searchContent}/>
                <Modal currentPost={currentPost} />
                <HomePage selectedAccount={selectedAccount} addPlus={addPlus} addMinus={addMinus} addNewPost={addNewPost} currentAccount={currentAccount} accounts={accounts} posts={posts} />
            </Route>
